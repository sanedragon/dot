...
[ -x `which git-completion.sh` ]    && source git-completion.sh
[ -x `which bash-colors.sh` ]       && source bash-colors.sh
[ -x `which git-helpers.sh` ]       && source git-helpers.sh
[ -x `which work.sh` ]              && source work.sh
